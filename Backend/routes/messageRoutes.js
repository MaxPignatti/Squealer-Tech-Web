...
router.get(
  "/messages/public/getAllMessages/:username/hashtag/:hashtag",
...
router.get(
  "/messages/public/getAllMessages/:username/targetUsername/:targetUsername",
...
router.get(
  "/messages/public/getAllMessages/:username/channel/:channel",
...
router.get(
  "/messages/public/getAllMessages/:username/text/:text",
