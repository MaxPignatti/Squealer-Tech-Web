...
router.get('/squeels/:username/:hashtag', messageController.getMessageByHashtag);
router.get('/privateMessages/:username/:hashtag', messageController.getPrivateMessByHashtag);
