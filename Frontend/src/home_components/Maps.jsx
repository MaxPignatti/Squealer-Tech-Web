...
const Maps = ({
	...
	useEffect(() => {
		...
		if (isLive && currentUser === message.user && message.maxSendCount > 0) {
			interval = setInterval(() => {
				...
				// Verifica se maxSendCount è ancora maggiore di 0 prima di inviare la posizione
	...
	}, [isLive, currentUser, message.user, message.maxSendCount]); // Aggiungi message.maxSendCount alle dipendenze
