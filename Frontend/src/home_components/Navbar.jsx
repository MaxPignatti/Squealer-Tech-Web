    ...
    <Navbar bg="light" expand="lg" sticky="top">
      <Container>
        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" onClick={toggleNavbar}>
          <FontAwesomeIcon icon={isVerticalNavbarOpen ? faXmark : faBars} id="symbol" />
        </Navbar.Toggle>
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <NavDropdown title="Menu" id="basic-nav-dropdown">
              <NavDropdown.Item as={NavLink} to="/Channels">
                Canali
              </NavDropdown.Item>
              <NavDropdown.Item as={NavLink} to="/Assistance">
                Assistenza
              </NavDropdown.Item>
              <NavDropdown.Item as={NavLink} to="/Shop">
                Shop
              </NavDropdown.Item>
              <NavDropdown.Item as={NavLink} to="/Ricerca">
